...
<div class="text-center">
    <div class="relative mx-auto h-32 w-64 overflow-hidden">
        <div class="absolute inset-0 rounded-t-full border-[34px] border-b-0 border-slate-200"></div>
        <div
            class="absolute inset-0 origin-bottom rounded-t-full border-[34px] border-b-0 border-inka-red"
